...
{
    /// <summary>
    /// MUST BE INITIALIZED FROM STAThread and not background thread
    /// </summary>
    public class InjectableKeyboardHook : IDisposable
    {
        public delegate void LocalKeyEventHandler(Keys key, bool shift, bool ctrl, bool alt);
        public event LocalKeyEventHandler KeyDown;
        public event LocalKeyEventHandler KeyUp;

        public bool HasKeyDownListeners => KeyDown != null;
        public bool HasKeyUpListeners => KeyUp != null;
